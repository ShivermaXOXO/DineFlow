...
const Navbar = () => {
    ...
    return (
        <>
        <nav className="bg-white shadow-md px-6 py-2 border-b border-gray-200">
            <div className="flex justify-between items-center">

                {/* Logo */}
                <div className="flex items-center space-x-3">
                    <div className="h-15 w-49">
                        <img src="/logo1.png" alt="DineFlow Logo" className="h-full w-full object-contain" />
                    </div>
                </div>
                ...
                <div className="hidden md:flex items-center space-x-6 text-gray-700 ml-auto">
                    ...
                    {!auth?.token ? (
                        ...
                        <button
                            ...
                            className="text-sm px-4 py-1.5 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition"
                        >
                            Logout
                        </button>
                    )}
